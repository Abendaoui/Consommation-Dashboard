...
import { operateursHeaders } from '../../../assets/data/data'
const operateursBody = [
  { id: 1, label: 'Redal' },
  { id: 2, label: 'Lydec' },
]
const Operateurs = () => {
  ...
  return (
    <section className='mx-auto max-w-7xl'>
      <AddButton title={'Ajouter Un Operateur'} handleOpen={handleOpen} />
      <article className='mt-10'>
        ...
        <div className='overflow-x-auto bg-white rounded-lg overflow-y-auto relative'>
          <DataTable
            headers={operateursHeaders}
            body={operateursBody.map((row) => (
